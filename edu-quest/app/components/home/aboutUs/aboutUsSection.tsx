      ...
      <div className="flex flex-col-2 md:flex-col-2 sm:flex-col-1 gap-8">
        ...
        <div className="relative w-full lg:w-1/2 md:w-1/2 flex flex-col gap-4 md:items-start">
          <div className="flex gap-4">
            <Image src="/assets/images/home/about.png" width={150} height={150} alt="about"  className="rounded-lg w-[50%] sm:w-[60%] md:w-[90%] lg:w-[80%]" />
          </div>
        </div>

        {/* Section Right */}
        <div className="w-full lg:w-1/2 md:w-1/2  md:text-left">
          <p className="bg-[#E9E2FF] text-[#704FE6] px-4 py-2 rounded-md font-medium inline-block">Our About Us</p>

          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mt-4">
            Learn & Grow Your <span className="relative inline-block">
