    ...
    <section className="relative min-h-screen max-w-7xl w-full mx-auto md:flex sm:inline-block gap-10 py-32 px-10">
      ...
      <div className="flex flex-col gap-5 w-full md:w-2/3">
        <Image
          ...
          height={1000}
        />
        <h1 className="text-4xl text-neutral-900 dark:text-white">{course.title}</h1>
        ...
        <div>
          ...
          <p className="text-neutral-800 dark:text-slate-300">{course.description}</p>
        </div>
        ...
        <div>
          ...
          <p className="text-neutral-800 dark:text-slate-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit...</p>
        </div>
        ...
        <div className="flex gap-8 bg-neutral-100 dark:bg-neutral-800 p-5 rounded-lg">
          <div className="flex items-center gap-6">
            <Avatar className="w-16 h-16">
              <AvatarImage src={course.instructor.profilePic} alt={course.instructor.fullName} />
              <AvatarFallback>
