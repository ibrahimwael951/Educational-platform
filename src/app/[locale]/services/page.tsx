...
<div className="w-full  border border-gray-200 bg-white p-8 rounded-lg shadow-sm">
...
return (
    ...
    <main className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           {/* card 1 */}
            <div className="flex flex-col items-center justify-center border border-gray-200 bg-white p-8 rounded-lg shadow-sm text-center">
            <Image src="/services/card2.png" alt="Woman recording a video lecture" width={200} height={160} />
            <h3 className="text-2xl font-bold text-gray-800 mt-6">Get Started with Video</h3>
            <p className="text-gray-600 mt-2">Quality video lectures can set your course apart. Use our resources to learn the basics.</p>
            ...
            <h3 className="text-2xl font-bold text-gray-800 mt-6">Connect with Instructors </h3>
            <p className="text-gray-600 mt-2">Get Inspired, Share Ideas, and Grow Together</p>
        ...
        <h2 className="text-4xl font-extrabold text-gray-900">Ready to Start Learning?</h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            ...
            <p className="text-gray-600 mt-2">Learn from industry professionals and passionate experts on thousands of topics.</p>
            </div>
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <CheckCircle className="w-8 h-8 text-purple-600 mb-3" />
            <h3 className="text-xl font-bold">Learn at Your Pace</h3>
            <p className="text-gray-600 mt-2">Enjoy lifetime access to courses on web and mobile. Learn anytime, anywhere.</p>
            </div>
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <CheckCircle className="w-8 h-8 text-purple-600 mb-3" />
            <h3 className="text-xl font-bold">Hands-On Learning</h3>
            <p className="text-gray-600 mt-2">Apply what you learn with quizzes, assignments, and practical projects.</p>
            </div>
        </div>
