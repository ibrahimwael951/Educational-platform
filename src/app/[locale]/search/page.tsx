...
const allCourses: Course[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 20822,
    imageUrl: "/images/course-react-2.jpg",
  },
  {
    id: "next-js-course",
  ...
  },
  {
    ...
    rating: 4.2,
    reviews: 45000,
    imageUrl: "/images/course-css.jpg",
  },
  {
    id: "agile-course",
    ...
    rating: 3.8,
    reviews: 12000,
    imageUrl: "/images/course-agile.jpg",
  },
];
...
const SearchResultsComponent = () => {
  ...
  useEffect(() => {
    ...
    if (typeof sidebarFilters.priceRange === "number") {
      results = results.filter(
        (course) => course.price <= sidebarFilters.priceRange!
      );
    }
    if (typeof sidebarFilters.rating === "number") {
      results = results.filter(
        (course) => course.rating >= sidebarFilters.rating!
      );
    }
      ...
      <div className="flex flex-col lg:flex-row gap-10 mt-10">
        ...
        <div className="flex-1">
          <p className="mb-6 text-sm text-neutral-600 dark:text-neutral-300">
            Showing <span className="font-bold">{currentCourses.length}</span>{" "}
            of <span className="font-bold">{filteredCourses.length}</span>{" "}
            results
          </p>
