...
const instructors = [
  { name: "Esther Howard", position: "Junior Instructor", image: "/home/inst1.png" },
  { name: "Beverly Hathcock", position: "Junior Instructor", image: "/home/inst2.png" },
  { name: "Donald Gonzales", position: "Junior Instructor", image: "/home/inst3.png" },
  { name: "Eddie Lenz", position: "Junior Instructor", image: "/home/inst4.png" },
];
        ...
        <div className="grid max-[600px]:grid-cols-1 max-[769px]:grid-cols-2 max-[4000px]:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-[url('/home/back.png')] p-6 text-left">
            ...
            <div className="flex gap-[7px] m-[5px]">
              ...
              <a href="#" className="button2">Find Courses →</a>
            </div>
          </div>
  
          <div className="grid grid-cols-2 gap-5 relative max-[600px]:grid-cols-1">
            {instructors.map((instructor, index) => (
              <div key={index} className="relative">
                ...
                className="relative m-[5px] w-full rounded-lg border-4 border-[#704FE6]" />
                <FaShareNodes className="absolute top-[2rem] right-[2rem] bg-[#704FE6] text-[#fff] rounded-full p-[10px] text-[2rem]" />

                <div className="absolute top-[17rem] left-[1rem] md:bottom-5 md:left-1/2 transform md:-translate-x-1/2 w-4/5 max-w-xs sm:max-w-sm bg-[#fff] rounded-lg p-3 md:p-4 z-10 text-left shadow-lg p-[5px]">
