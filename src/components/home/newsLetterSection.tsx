...
const NewsletterSection = () => {
  ...
  return (
    <section className=" relative w-full h-[400px] md:h-[500px] lg:h-[600px] bg-purple-600 px-4 flex flex-col items-center justify-center gap-10  bg-cover bg-center  mt-32">
